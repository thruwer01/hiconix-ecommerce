		...
		<div class="row align-items-center" style="min-height: calc(100vh - 140px)">
			<div class="col-lg-7">
				<div class="page-title">
					<div class="top-head-1">Федеральный дистрибьютор</div>
					<h1>Хиконикс</h1>
					...
					<div class="row pl-md-3">
						<div class="row mt-2 mb-2 align-items-center">
							...
							<div class="col-4 text-center mb-2">
								<img height="70px" src="/images/index_page/image_partners_2.png">
							</div>
							<div class="col-8">
								Свыше <span class="counter" data-counter-speed="10" data-counter-autoincrement="4550">
									0
			 			...
			 			<div class="row mt-2 mb-2 align-items-center">
							...
							<div class="col-4 text-center mb-2">
								<img height="70px" src="/images/index_page/image_ingeners_2.png">
							</div>
							<div class="col-8">
								В помощь <span class="counter" data-counter-speed="25" data-counter-autoincrement="350">
									0
						...
						<div class="row mt-2 mb-2 align-items-center">
							<div class="col-4 text-center mb-2">
								<img height="70px" src="/images/index_page/image_word_2.png">
							</div>
							<div class="col-8">
								В более <span class="counter" data-counter-speed="35" data-counter-autoincrement="100">
									0
								</span> странах <br> представлены наши бренды
							</div>
						</div>
						<div class="row mt-2 mb-2 align-items-center">
							<div class="col-4 text-center mb-2">
								<img height="70px" src="/images/index_page/image_years_2.png">
							</div>
							<div class="col-8">
						...
						<div class="row mt-2 mb-2 align-items-center">
							...
							<div class="col-4 text-center mb-2">
								<img height="70px" src="/images/index_page/image_billion_2.png">
							</div>
							<div class="col-8">
								Присутствие в <span class="counter" data-counter-speed="75" data-counter-autoincrement="20">
									0
								</span> городах миллионниках
							</div>
...
<div class="container pt-5">
    ...
    <div class="row pt-3">
        <div class="col-md-6 order-2 order-md-1">
            Компания «Хиконикс» – крупный поставщик климатического оборудования. Более 25 лет мы успешно сотрудничаем с дистрибьюторами и оптовыми покупателями со всей России. Мы – эксклюзивные представители бренда AUX (Аукс) и Ecoclima (Экоклима) на территории РФ. Также предлагаем климатическое оборудование мировых производителей: Electrolux (Электролюкс), Panasonic (Панасоник), Komfovent (Комфовент) и Mitsubishi Electric (Митсубиси). Эти компании делают акцент на надежности своей продукции, энергоэффективности, современном дизайне и используют инновационный подход при разработке систем вентиляции и кондиционирования воздуха.
		</div>
