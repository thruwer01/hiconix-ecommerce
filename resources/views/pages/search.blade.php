        ...
        <div class="col-4">
            <form action="/search" method="GET">
                ...
                <div style="position: relative;">
                    <input type="text" value="{{$searchInput}}" name="q" class="form-control" placeholder="Кондиционер AUX" style="padding-left: 40px;">
                    <span class="input-group-append" style="position: absolute; top: 5px; left: 10px;">
                        <button type="submit">
...
<div class="container mt-2">
    <h1>Результаты по запросу: "{{$searchInput}}"</h1>
    <span class="text-muted">
        Всего найдено: {{count($products)}} товар(ов)
    </span>
    <div class="row mt-5">
