...
<div class="container mb-5">
    ...
    <div class="row mt-3">
            ...
            <div id="pinfo" class="mt-5">
                ...
                <div class="row products mt-3">
					...
					<div class="col-12 col-sm-6 col-md-12 col-lg-6 col-xl-4">
						<div class="p-2 mb-3 border product-main" style="max-width: 250px; min-height: 400px; position:relative;">
							...
							<div class="main-info pt-2">
								...
								<div style="font-size: 15px;">
									<a href="/products/{{$set->slug}}" class="name">{{$set->brand->name}} {{$set->model}} {{$set->squere}} м²</a>
								</div>
							</div>
							...
							<div class="product-buttons" style="font-size: 12px; display: flex; position: relative; justify-content: space-between; width: 100%;">
								<div>
									<button onclick="location.href='/products/{{$set->slug}}';" class="p-2 px-3 p-info">Подробнее</button>
								</div>
								<div>
									<button data-product-id="{{$set->id}}" id="inCartBtn" class="p-2 px-4 in-cart active text-nowrap">В корзину</button>
								</div>
							</div>
						</div>
					</div>
        ...
        <div class="col-md-4 p-2 order-1 order-md-2">
